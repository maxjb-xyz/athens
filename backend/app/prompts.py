...
USER_TEMPLATE = (
    ...
    "- Each section should be about ONE concept. Within a section, cover that concept with MULTIPLE different module types (for example: a text explanation, then an example, then a pitfall, then a quick quiz, all about the same idea). Do not give each concept only a single module.\n"
    "- You may repeat module types across sections, and include as many or as few of each as the topic needs.\n"
